import 'package:crm/features/pedido/presentation/widgets/buscar_pedido_movimiento.dart';
import 'package:crm/features/pedido/presentation/widgets/buscar_pedidos_cliente.dart';
...
import 'package:crm/features/pedido/presentation/widgets/cabs_ped_rango/card_cab_ped_rango.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                isLoading
                    ...
                    : cabsPedRango == null || cabsPedRango.isEmpty
                    ? SizedBox(
                      height: MediaQuery.of(context).size.height / 2,
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
